        ...
        return (
            <div className={SettingsManagerStyles.settings_manager}>
                ...
                <div className={SettingsManagerStyles.settings__buttons_box}>
                    <button className={SettingsManagerStyles.settings__buttons_box__save_button} onClick={this.save}>
                        Save
                    </button>
                </div>
            </div>
